...
// "../components/SuspenseWrapper/SuspenseWrapper";
      ...
      children: [
        {
          ...
          children: [
            { path: "/cashier/dashboard", Component: CashierDashboardPage },
            { path: "/cashier/management-menu-stock", Component: CashierMenuStockPage },
            { path: "/cashier/management-menu-stock/add-menu", Component: CashierAddMenuPage },
            { path: "/cashier/management-menu-stock/edit-menu/:id", Component: CashierEditMenuPage },
            { path: "/cashier/management-menu-stock/detail-menu/:id", Component: CashierDetailMenuPage },
            { path: "/cashier/order-list", Component: CashierOrderListPage },
            { path: "/cashier/order-list/payment-validation", Component: CashierPaymentValidationPage },
            { path: "/cashier/order-list/create-order", Component: CashierCreateOrderPage },
            { path: "/cashier/order-list/create-order/select-table", Component: CashierSelectTablePage },
            { path: "/cashier/order-list/create-order/select-menu", Component: CashierSelectMenuPage },
            { path: "/cashier/order-list/create-order/payment-order", Component: CashierPaymentPage },
            { path: "/cashier/management-table", Component: CashierTableManagementPage },
            { path: "/cashier/management-discount", Component: CashierDiscountManagementPage },
            { path: "/cashier/report", Component: CashierReportPage },
          ],
        },
        { path: "/cashier/profile", Component: CashierProfilePage },
      ],
    },
      ...
      children: [
        {
          ...
          children: [
            { path: "/waiter/dashboard", Component: WaiterDashboardPage },
            { path: "/waiter/create-order", Component: WaiterCreateOrderPage },
            { path: "/waiter/create-order/select-table", Component: WaiterSelectTablePage },
            { path: "/waiter/create-order/select-menu", Component: WaiterSelectMenuPage },
            { path: "/waiter/create-order/payment-order", Component: WaiterPaymentPage },
            { path: "/waiter/order-list", Component: WaiterOrderListPage },
            { path: "/waiter/table-management", Component: WaiterTableManagementPage },
            { path: "/waiter/table-management/:id", Component: WaiterTableDetailPage },
          ],
        },
        { path: "/waiter/profile", Component: WaiterProfilePage },
      ],
    },
      ...
      children: [
        {
          ...
          children: [
            { path: "/kitchen/order-list", Component: KitchenOrderListPage },
            { path: "/kitchen/menu-stock", Component: KitchenMenuStockPage },
            { path: "/kitchen/menu-stock/detail-menu/:id", Component: KitchenDetailMenuPage },
          ],
        },
        { path: "/kitchen/profile", Component: KitchenProfilePage },
      ],
    },
