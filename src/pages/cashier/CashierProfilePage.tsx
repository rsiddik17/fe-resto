...
const CashierProfilePage = () => {
  ...
  // atau fallback ke data Rina Lusiana sesuai desain jika data kosong
  const profileData = {
    fullname: user?.fullname || "Rina Lusiana",
    phone: user?.phone_number || "+62 811 921 827",
    gender: user?.gender || "Perempuan",
    email: user?.email || "kasiritsresto@gmail.com",
