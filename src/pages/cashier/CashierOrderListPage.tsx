...
const getBadgeColor = (type: string) => {
  switch (type.toUpperCase()) {
    case "ONLINE": return "bg-[#BA68C8]"; // Ungu Muda
    case "KIOSK": return "bg-[#2196F3]"; // Biru
    case "QR": return "bg-[#1AE91D]"; // Hijau Terang
    case "WAITER": return "bg-[#F35B28]"; // Orange
    case "DIMASAK": return "bg-[#FF9100]"; // Orange/Kuning Tua
    case "SIAP SAJI": return "bg-[#8AC926]"; // Hijau Muda (Kekuningan)
    case "SELESAI": return "bg-[#90EB00]"; // Hijau
    case "DIBATALKAN": return "bg-[#73736C]"; // Abu-abu
    case "DELIVERY": return "bg-primary"; // Ungu Tua
    case "DINE IN": return "bg-primary"; // Ungu Tua
...
const RAW_MOCK_ORDERS = [
  // ================= 1. MENUNGGU VALIDASI =================
  {
    id: "ord-1", orderId: "#26040599", time: "12:50", title: null, statusFilter: "Menunggu Validasi",
  ...
  {
    id: "ord-6", orderId: "#26040577", time: "13:50", title: null, statusFilter: "Menunggu Validasi",
    rawLeftBadges: ["ONLINE", "Delivery"],
    rawRightBadges: [],
    items: [
      { name: "Kwetiau Goreng", qty: 1, note: "Pedas", price: 25000 },
  ...
  {
    id: "ord-2", orderId: "#260405100", time: "13:01", title: "Meja 02", statusFilter: "Menunggu Validasi",
    rawLeftBadges: ["KIOSK"],
  ...
  {
    id: "ord-5", orderId: "#260405111", time: "14:01", title: "Meja 03", statusFilter: "Menunggu Validasi",
    rawLeftBadges: ["KIOSK"],
    rawRightBadges: ["Dine in"],
    items: [
  ...
  {
    id: "ord-qr-1", orderId: "#260405115", time: "14:15", title: "Meja 08", statusFilter: "Menunggu Validasi",
    rawLeftBadges: ["QR"],
    rawRightBadges: ["Dine in"],
    items: [
  ...
  // ================= 2. SEDANG DIPROSES =================
  {
    id: "ord-3", orderId: "#26040595", time: "10:30", title: null, statusFilter: "Sedang diproses",
    rawLeftBadges: ["ONLINE", "Delivery"],
  ...
  {
    id: "ord-4", orderId: "#26040597", time: "10:49", title: "Meja 06", statusFilter: "Sedang diproses",
    rawLeftBadges: ["KIOSK"],
  ...
  {
    id: "ord-waiter-1", orderId: "#26040602", time: "11:05", title: "Meja 12", statusFilter: "Sedang diproses",
    rawLeftBadges: ["WAITER"],
    rawRightBadges: ["Dine in", "Dimasak"],
    items: [
      { name: "Nasi Goreng Seafood", qty: 1, note: "Pedas Sedang", price: 35000 },
  ...
  // ================= 3. SELESAI =================
  {
    id: "ord-5-selesai", orderId: "#26040591", time: "09:30", title: null, statusFilter: "Selesai",
    rawLeftBadges: ["ONLINE", "Delivery"],
  ...
  {
    id: "ord-qr-2", orderId: "#26040650", time: "09:45", title: "Meja 05", statusFilter: "Selesai",
    rawLeftBadges: ["QR"],
  ...
  // ================= 4. DIBATALKAN =================
  {
    id: "ord-6-batal", orderId: "#260405941", time: "09:30", title: null, statusFilter: "Dibatalkan",
    rawLeftBadges: ["ONLINE", "Delivery"],
...
const FILTERS = ["Menunggu Validasi", "Sedang diproses", "Selesai", "Dibatalkan"];
          ...
          {filteredOrders.length > 0 ? (
            filteredOrders.map((order) => (
              <CashierOrderCard
                ...
                onValidate={() => navigate(`/cashier/order-list/payment-validation`, {state: { dataOrder: order }})}
              />
            ))
          ) : (
