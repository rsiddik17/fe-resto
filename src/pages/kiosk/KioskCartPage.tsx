      ...
      <main className="flex-1 w-full max-w-3xl mx-auto pt-6">
        ...
        {items.length > 0 ? (
          ...
          <div className="flex-1 flex flex-col items-center justify-center mt-10 md:mt-25">
            ...
            />
            <p className="text-gray text-[22px] mb-6 text-center">
              Keranjangmu masih kosong, yuk pilih menu!
            </p>
            <Button
              onClick={handleBackToMenu}
              className="px-8 w-full max-w-100 py-2.5 rounded-full flex justify-center items-center gap-2"
            >
      ...
      {items.length > 0 && (
          <div className="w-full max-w-150 mx-auto">
            <Button
              ...
              className="w-full mx-auto py-3 rounded-full font-bold text-lg"
            >
