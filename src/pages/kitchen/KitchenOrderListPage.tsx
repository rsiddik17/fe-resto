...
const MOCK_ORDERS: OrderDetail[] = [
  // === PESANAN MASUK ===
  {
    ...
    status: "MASUK",
    items: [
      { qty: 1, name: "Nasi Goreng" },
      { qty: 2, name: "Bakso Urat" },
    ],
  },
  {
    id: "#ORD-125",
    ...
    items: [
      { qty: 1, name: "Es Teler" },
      { qty: 2, name: "Bakso Urat" },
      { qty: 1, name: "Lychee Tea" },
      { qty: 3, name: "Dimsum" },
      { qty: 1, name: "Lemon Tea" },
    ],
  },
  {
    id: "#ORD-126",
    ...
    status: "MASUK",
    items: [
      { qty: 1, name: "Kwetiau Goreng" },
      { qty: 2, name: "Nasi Goreng" },
      { qty: 1, name: "Lychee Tea" },
      { qty: 3, name: "Air Mineral" },
      { qty: 1, name: "Lemon Tea" },
      { qty: 1, name: "Roti Bakar" },
      { qty: 1, name: "Matcha Latte" },
      { qty: 2, name: "Es Jeruk" },
      { qty: 2, name: "Es Cincau" },
      { qty: 2, name: "Es Kelapa" },
    ],
  },
  {
    id: "#ORD-127",
  ...
  },
  {
    ...
    items: [
      { qty: 1, name: "Kwetiau Goreng" },
      { qty: 2, name: "Nasi Goreng" },
      { qty: 3, name: "Lychee Tea" },
      { qty: 3, name: "Air Mineral" },
      { qty: 1, name: "Soto Ayam" },
      { qty: 1, name: "Nasi Liwet" },
    ],
  },
  {
    ...
    items: [
      { qty: 1, name: "Dimsum" },
      { qty: 2, name: "Mie Ayam Bakso" },
      { qty: 2, name: "Es Teler" },
      { qty: 3, name: "Lemon Tea" },
    ],
  },
  {
    id: "#ORD-130",
  ...
  },
  {
    ...
    status: "MASUK",
    items: [
      { qty: 1, name: "Nasi Goreng Kambing", note: "Tidak Pedas" },
      { qty: 2, name: "Es Teler" },
      { qty: 1, name: "Ayam Penyet" },
      { qty: 1, name: "Mie Ayam Bakso" },
      { qty: 1, name: "Lemon Tea" },
      { qty: 1, name: "Roti Bakar", note: "Bakar tipis" },
      { qty: 1, name: "Nasi Bakar", note: "Bakar tipis" },
      { qty: 2, name: "Es Jeruk", note: "Bakar tipis" },
    ],
  },
  {
    id: "#ORD-133",
  ...
  // === MEMASAK ===
  {
    ...
    items: [
      { qty: 3, name: "Sop Iga" },
      { qty: 1, name: "Bakso Urat" },
      { qty: 4, name: "Le Mineral" },
    ],
  },
  {
    id: "#ORD-60",
  ...
  },
  {
    ...
    status: "MEMASAK",
    items: [
      { qty: 2, name: "Milkshake Stroberi" },
      { qty: 2, name: "Cireng Bumbu Rujak" },
      { qty: 2, name: "Roti Bakar" },
    ],
  },
  {
    id: "#ORD-57",
    ...
    items: [
      ...
      { qty: 1, name: "Capcay" },
      { qty: 2, name: "Dimsum" },
      { qty: 2, name: "Kwetiau Goreng" },
      { qty: 1, name: "Pempek" },
      { qty: 2, name: "Es Kelapa Muda" },
    ],
  },
  {
    id: "#ORD-56",
  ...
  },
  {
    ...
    status: "MEMASAK",
    items: [
      { qty: 2, name: "Nasi Liwet" },
      { qty: 2, name: "Lychee Tea" },
    ],
  },
  {
    id: "#ORD-53",
  ...
  },
  {
    ...
    items: [
      { qty: 2, name: "Capcay" },
      { qty: 2, name: "Nasi Bakar" },
      { qty: 1, name: "Nasi Kuning" },
      { qty: 4, name: "Lychee Tea" },
      { qty: 1, name: "Matcha Latte" },
      { qty: 1, name: "Le Mineral" },
    ],
  },
  {
    id: "#ORD-20",
    ...
    status: "SIAP_SAJI",
    items: [
      { qty: 2, name: "Le Mineral" },
      { qty: 1, name: "Gado-Gado" },
      { qty: 1, name: "Nasi Goreng Udang" },
      { qty: 1, name: "Jus Alpukat" },
    ],
  },
  {
    id: "#ORD-21",
  ...
  },
  {
    ...
    status: "SIAP_SAJI",
    items: [
      { qty: 1, name: "Nasi Goreng Kambing" },
      { qty: 1, name: "Sate Ayam" },
      { qty: 1, name: "Bakso Urat" },
      { qty: 2, name: "Lemon Tea" },
    ],
  },
  {
    id: "#ORD-23",
  ...
  },
  {
    ...
    items: [
      { qty: 1, name: "Dimsum" },
      { qty: 2, name: "Roti Bakar Cokelat" },
      { qty: 2, name: "Pempek" },
      { qty: 2, name: "Jus Mangga" },
      { qty: 1, name: "Soto Ayam" },
    ],
  },
  {
  ...
  const handleConfirmAction = () => {
    if (selectedOrderAction) {
      ...
      const nextStatus: OrderStatus =
        selectedOrderAction.status === "MASUK" ? "MEMASAK" : "SIAP_SAJI";
