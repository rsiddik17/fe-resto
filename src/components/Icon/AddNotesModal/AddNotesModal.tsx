...
// Menambahkan interface supaya TypeScript mendukung prop 'size'
interface IconProps extends SVGProps<SVGSVGElement> {
  size?: number | string;
}

export default function AddNotesIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg 
