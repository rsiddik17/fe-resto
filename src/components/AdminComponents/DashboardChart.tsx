...
const DashboardChart = ({ title, data, barColorClass = "bg-primary", isRevenue = false }: DashboardChartProps) => {
  const maxValue = 500;

  return (
    <div className="bg-white rounded-xs p-5 px-6 shadow-sm border border-gray-100 flex-1 min-w-[320px] max-w-140 mx-auto lg:mx-0">
      <h3 className="text-center font-bold text-gray-850 text-[14.5px] mb-6">{title}</h3>
      
      {/* Area Utama Grafik */}
      <div className="flex h-48 gap-5 items-end relative pb-6 pl-12 pr-2">
