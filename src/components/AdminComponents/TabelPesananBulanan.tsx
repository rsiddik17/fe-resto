...
interface TabelPesananBulananProps {
  data: PesananBulanan[];
  onSortChange?: (sortedData: PesananBulanan[]) => void;
}

export default function TabelPesananBulanan({ data, onSortChange }: TabelPesananBulananProps) {
  ...
  const sortedData = [...data].sort((a, b) => {
    ...
    // Untuk field number (totalPesanan, selesai, cancel)
  ...
  useEffect(() => {
    if (onSortChange) {
      ...
      // Hanya panggil jika data berubah
  ...
  // ✅ Perbaiki reduce: harus ambil properti yang benar
