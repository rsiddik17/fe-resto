          ...
          <div className="flex flex-wrap gap-2">
            {[
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-xs text-xs font-medium transition-all ${sortField === option.key ? "bg-primary text-white shadow-sm" : "bg-white-100 border text-gray-800 hover:bg-gray-200"}`}
              >
                {option.label}
