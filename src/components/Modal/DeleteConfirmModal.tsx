...
const DeleteConfirmModal = ({ onClose, onConfirm }: DeleteConfirmModalProps) => {
  return (
    ...
    >
      <div 
        className="bg-white w-full max-w-[88%] md:max-w-131.5 min-h-74 md:h-94 lg:max-w-98 lg:min-h-0 lg:h-65 rounded-2xl pt-8 pb-6 px-4 md:pt-9 md:pb-8 md:px-8 lg:pb-3 lg:pt-6 shadow-sm flex flex-col items-center text-center animate-in zoom-in-95 duration-200"
      ...
      >
        ...
        <div className="flex justify-center w-full gap-x-8 md:gap-x-16 lg:gap-x-6 mt-0">
          <Button 
            ...
            className="flex-1 max-w-35 md:max-w-41.75 lg:max-w-30 py-2 md:py-2.5 lg:py-1.5 font-normal text-[15px] md:text-lg lg:text-[15px] bg-[#FFFFFF] hover:bg-black/5 text-black border-[1.5px] border-gray/50"
          >
            Batal
          </Button>
