    ...
    >
      ...
      >
        ...
        {/* Teks Konfirmasi */}
          ...
          <p className="text-[12px] md:text-[13px] mb-6 md:mb-8 leading-relaxed px-2">
        ...
        <div className="w-full flex flex-col gap-3">
          <Button
            onClick={onViewCart}
            className="w-full py-2 md:py-2.5 text-sm md:text-base rounded-sm md:rounded-md font-bold"
          >
            Lihat Keranjang
          </Button>
          ...
          <Button
            onClick={onClose}
            className="w-full py-2 md:py-3 text-sm md:text-base rounded-sm md:rounded-md font-bold bg-primary/40 hover:bg-primary/50 text-primary transition-colors"
          >
            Kembali ke Menu
          </Button>
        </div>
