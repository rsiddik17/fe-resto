  ...
  const downloadPDF = () => {
    try {
      ...
      items.forEach((item) => {
        ...
        const displayNote =
          rawNote === "" || rawNote === "-" ? "Tidak ada catatan" : rawNote;
      ...
      if (discountAmount > 0) {
        ...
        pdf.text(`-${formatRupiah(discountAmount)}`, 75, currentY, {
          align: "right",
        });
        currentY += 5;
      }
      ...
      pdf.setFont("Helvetica", "italic");
      pdf.setTextColor(150, 150, 150);
      pdf.text("Terima kasih telah memesan!", 40, currentY, {
        align: "center",
      });
    ...
    <div className="fixed inset-0 z-999 bg-white flex flex-col h-screen w-screen overflow-hidden">
      <div className="print:hidden shrink-0 bg-white border-b border-gray-100">
        ...
        <div className="px-4 md:px-8 py-2 flex items-center gap-3">
          <button
            onClick={onClose}
            className="hover:bg-gray-100 p-1.5 rounded-full shrink-0 transition-colors"
          >
        ...
        <div className="flex flex-col md:flex-row min-h-full">
          <div className="bg-primary w-full md:w-[42%] flex flex-col items-center py-6 md:py-10 px-4 shrink-0">
            ...
            >
              ...
              <p className="text-gray-400 font-medium text-[11px] uppercase mb-3">
                Rincian Pembayaran
              </p>
                    ...
                    <div key={idx} className="flex justify-between items-start">
                      <div className="flex flex-col pr-4">
                        ...
                        <div className="flex items-center gap-1 mt-1 text-gray-400">
                          ...
                          <span
                            className={`text-[10px] font-medium ${hasNoNote ? "italic text-gray-400" : "text-gray-500"}`}
                          >
              ...
              <div className="border-t-2 border-gray-100 pt-4 mt-2">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-black font-extrabold text-[18px] tracking-tighter">
