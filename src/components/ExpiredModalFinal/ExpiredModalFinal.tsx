...
const ExpiredModalOnlineFinal = ({ onClose }: ExpiredModalProps) => {
  ...
  return (
    <div className="fixed inset-0 z-100 flex items-center justify-center bg-black/10 backdrop-blur-[2px] p-4">
      <div 
...
export default ExpiredModalOnlineFinal;